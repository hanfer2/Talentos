<?php /* Smarty version 2.6.26, created on 2011-07-12 09:30:44
         compiled from modules/i_competencias_estudiantes/templates/reporte_general.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'nombre_programa', 'modules/i_competencias_estudiantes/templates/reporte_general.tpl', 3, false),array('function', 'math', 'modules/i_competencias_estudiantes/templates/reporte_general.tpl', 61, false),array('function', 'link_to', 'modules/i_competencias_estudiantes/templates/reporte_general.tpl', 118, false),array('modifier', 'underscorify', 'modules/i_competencias_estudiantes/templates/reporte_general.tpl', 14, false),array('modifier', 'escape', 'modules/i_competencias_estudiantes/templates/reporte_general.tpl', 22, false),array('modifier', 'upper', 'modules/i_competencias_estudiantes/templates/reporte_general.tpl', 22, false),array('modifier', 'truncate', 'modules/i_competencias_estudiantes/templates/reporte_general.tpl', 22, false),array('modifier', 'capitalize', 'modules/i_competencias_estudiantes/templates/reporte_general.tpl', 30, false),array('modifier', 'ucfirst', 'modules/i_competencias_estudiantes/templates/reporte_general.tpl', 42, false),array('modifier', 'string_format', 'modules/i_competencias_estudiantes/templates/reporte_general.tpl', 61, false),)), $this); ?>
...
?>
						...
						<?php $this->assign('p', $this->_tpl_vars['grupo'][$this->_tpl_vars['componente']][$this->_tpl_vars['nombre_competencia']]); ?>
						<td>
    ...
    foreach ($_from as $this->_tpl_vars['grupo']):
?>
	<div class="outer-i_calificador-reporteGeneral ui-helper-hidden ui-corner-top" id="outer-competencias-reporteGeneral-<?php echo $this->_tpl_vars['grupo']; ?>
">
				<h3 class="header-widget ui-state-default ui-corner-top" id='header-competencias-reporteGeneral-<?php echo ((is_array($_tmp=$this->_tpl_vars['grupo'])) ? $this->_run_mod_handler('underscorify', true, $_tmp) : underscorify($_tmp)); ?>
...
"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['componente'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 3, "") : smarty_modifier_truncate($_tmp, 3, "")))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
		...
		<div class="wrapper-i_calificador-reporteGeneral wrapper-i_calificadores-reporteGeneral" id='wrapper-competencias-reporteGeneral-<?php echo $this->_tpl_vars['grupo']; ?>
'>
...
?>
						<?php $this->assign('nombre_competencia', $this->_tpl_vars['competencia']['nombre_competencia']); ?>
						<?php $this->assign('p', $this->_tpl_vars['curso']['puntajes'][$this->_tpl_vars['componente']][$this->_tpl_vars['nombre_competencia']]); ?>
						<td>
							<span class="cantidad-preguntas-correctas"><?php echo ((is_array($_tmp=$this->_tpl_vars['p']['puntaje'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.0f") : smarty_modifier_string_format($_tmp, "%.0f")); ?>
</span><sub class="tiny">/ <?php echo smarty_function_math(array('equation' => "preguntas*total",'preguntas' => $this->_tpl_vars['p']['preguntas'],'total' => $this->_tpl_vars['p']['cantidad']), $this);?>
</sub>
