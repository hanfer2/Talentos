<?php /* Smarty version 2.6.26, created on 2011-10-27 16:22:45
         compiled from ./modules/asistencias/templates//claseporcomponente.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', './modules/asistencias/templates//claseporcomponente.tpl', 2, false),array('modifier', 'default', './modules/asistencias/templates//claseporcomponente.tpl', 42, false),array('modifier', 'date_format', './modules/asistencias/templates//claseporcomponente.tpl', 61, false),array('function', 'include_template', './modules/asistencias/templates//claseporcomponente.tpl', 5, false),array('function', 'include_partial', './modules/asistencias/templates//claseporcomponente.tpl', 66, false),)), $this); ?>
<?php if (empty ( $this->_tpl_vars['cursoxcomponente'] )): ?>
	<p>No hay Inasistencias Reportadas para el componente <?php echo $this->_tpl_vars['nombre']['cod_componente']; ?>
-<?php echo ((is_array($_tmp=$this->_tpl_vars['nombre']['nombre_componente'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</p>
<?php else: ?>
<!--
...
<div class="ui-widget decorated">
  <h1>Listado de Asistencias Por Cursos Componente <?php echo $this->_tpl_vars['nombre']['cod_componente']; ?>
-<?php echo ((is_array($_tmp=$this->_tpl_vars['nombre']['nombre_componente'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</h1>
