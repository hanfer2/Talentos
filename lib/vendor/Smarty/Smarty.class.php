 ...
 */
    ...
    function assign($tpl_var, $value = null)
    {
        if (is_array($tpl_var)){
            ...
            if ($tpl_var != ''){
//              if(isset($this->_tpl_vars[$tpl_var]) && $this->_tpl_vars[$tpl_var] != $value)
 //               trigger_error("Se sobrescribira la variable $tpl_var, de {$this->_tpl_vars[$tpl_var]} a $value", E_USER_NOTICE);
   ...
   /**
    ...
    {
      $compile_id = (preg_match("/\.\.\/_(public|layout)/", $resource_name))? 'global': $this->_compile_id;
      return $this->_get_auto_filename($this->compile_dir, $resource_name, $compile_id) . '.php';
    }
    ...
    function _fetch_resource_info(&$params)
    {
        ...
        if (!$_return) {
            if (!$params['quiet']) {
                $this->trigger_error('unable to read resource: "'.$_params['resource_base_path'].'/' . $params['resource_name'] . '"');
            }
