{if empty($cursoxcomponente)}
	<p>No hay Inasistencias Reportadas para el componente {$nombre.cod_componente}-{$nombre.nombre_componente|escape}</p>
{else}
<!--
...
<div class="ui-widget decorated">
  <h1>Listado de Asistencias Por Cursos Componente {$nombre.cod_componente}-{$nombre.nombre_componente|escape}</h1>
