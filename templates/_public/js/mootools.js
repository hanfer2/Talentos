...
jQuery.each(['Object', 'WhiteSpace', 'TextNode', 'Collection', 'Arguments'],function(name){
	new Type(name);
});
...
// MooTools: the javascript framework.
// Load this file's selection again by visiting: http://mootools.net/more/722fe39d2a81f82208b41ee0f7292634
// Or build this file again with packager using: packager build More/More More/Events.Pseudos More/Array.Extras More/Date More/Date.Extras More/Number.Format More/String.Extras More/URI More/Hash More/Hash.Extras
/*
---
...
MooTools.lang.set('es-ES','Date',{months:['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'],days:['Domingo','Lunes','Martes','Miércoles','Jueves','Viernes','Sábado'],dateOrder:['date','month','year'],AM:'AM',PM:'PM',shortDate:'%d/%m/%Y',shortTime:'%H:%M',ordinal:'',lessThanMinuteAgo:'hace menos de un minuto',minuteAgo:'hace un minuto',minutesAgo:'hace {delta} minutos',hourAgo:'hace una hora',hoursAgo:'hace unas {delta} horas',dayAgo:'hace un día',daysAgo:'hace {delta} días',weekAgo:'hace una semana',weeksAgo:'hace unas {delta} semanas',monthAgo:'hace un mes',monthsAgo:'hace {delta} meses',yearAgo:'hace un año',yearsAgo:'hace {delta} años',lessThanMinuteUntil:'hace menos de un minuto',minuteUntil:'hace un minuto',minutesUntil:'hace {delta} minutos',hourUntil:'hace una hora',hoursUntil:'hace unas {delta} horas',dayUntil:'hace un día',daysUntil:'hace {delta} dí­as',weekUntil:'hace una semana',weeksUntil:'hace unas {delta} semanas',monthUntil:'hace un mes',monthsUntil:'hace {delta} meses',yearUntil:'hace un año',yearsUntil:'hace {delta} años'});

String.prototype.camelize = function(){
	return this.trim().replace(/_{2,*}\D/g,'_').replace(/_\D/g, function(match){
		return match.charAt(1).toUpperCase();
	}).capitalize();
};
